...
class creativecommons_license {
  ...
  function post_answers($questions) {
    ...
    if (isset($id) && $id != 'none' && $id != 'traditionalcopyright' || $id != 'gpl') {
  ...
  function get_images($site_license = false) {
    ...
    switch ($display) {
      ...
      case (2):        
        ...
        /* EI Code Starts */
        else if($this->license_type == 'traditionalcopyright') {
          $images[] = $img_path . '/icon-publicdomain.png';
        }
        else if($this->license_type == 'gpl') {
          $images[] = $img_path . '/icon-publicdomain.png';
        }
        /* EI Code Ends */
  ...
  function get_rdf() {
    ...
    if (is_null($this->license_type) || $this->license_type == 'none' || $this->license_type == 'traditionalcopyright' || $this->license_type == 'gpl')
      return;
